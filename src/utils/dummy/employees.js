  ...
  employees: [
    {
      ...
      emp: {
        ...
        grades: [
          {
            ...
            ds: "5",
            grade: "SE-PG",
            startDate: "2017-03-10T07:41:45.444Z"
          }
        ],
        familyMembers: [
          {
            id: "f_93",
            isActive: true,
            name: "Melani Larasati",
            gender: "Female",
            dob: "2017-03-13T03:16:27.775Z",
            relation: "Wife"
          },
          {
            id: "f_51",
        ...
        projects: [
          {
            ...
            jobDesc: [
              ...
              "Managing and deploying & releasing production",
              "Lead IMB ODC team (7 members)",
              "Tools & Technology: IntelliJ IDE, Jenkins, Git, Maven, some",
              "Other"
            ]
          },
          {
          ...
          {
            id: "p_0_3",
            start: "2016-01-31T17:00:00.000Z",
            end: "2017-01-12T17:00:00.000Z",
            projectName: "VIET SOFTWARE INTERNATIONAL",
            role: "JAVA DEVELOPER",
            jobDesc: [
              "Optimizing performance at customer projects",
              "Working & implementing web portal using Liferay & gatein portal Internet banking system",
              "Managing and deploying & releasing production",
              "Lead IMB ODC team (7 members) nice",
              "Tools & Technology: IntelliJ IDE, Jenkins, Git, Maven, some",
              " ok deh kamu juga boleh"
            ]
          },
          {
            id: "p_0",
            start: "2017-01-31T17:00:00.000Z",
            projectName: "CDC RMS",
            role: "Front end developer",
            jobDesc: [
              " implement mockup for rms"
            ]
          }
        ],
        address: {
          streetAddress: "Jl Pulo Raya VI no 3",
        ...
        locations: [
          {
            id: "l_23",
            start: "2014-09-02T17:00:00.000Z",
            end: "2016-12-01T17:00:00.000Z",
            officeLocation: "Yogyakarta"
          },
          {
            id: "l_91",
            start: "2017-03-13T09:14:16.075Z",
            officeLocation: "Bandung",
            end: "2017-03-14T01:04:45.141Z"
          }
        ]
      }
    }
